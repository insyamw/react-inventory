...
export default function DeletedStuff() {
            ...
            <div className="block m-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="items-center m-5 pb-10 pt-10">
                    <div className="flex justify-between">
                        <h5 className="mb-1 ml-5 text-3xl font-medium text-gray-900 dark:text-white">Deleted Stuff</h5>
                    </div>
                    {
                                ...
                                {stuffs.map((stuff, id) => (
                                    <tr key={stuff.id} className="border-b dark:border-neutral-500 dark:text-white">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4">
                                            <button type="button" onClick={() => restoreStuff(stuff.id)} className="px-4 py-2 bg-green-500 rounded-lg mr-2 font-bold text-white">Restore</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
