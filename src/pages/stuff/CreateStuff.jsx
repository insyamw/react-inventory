            ...
            <div className="block m-auto h-screen bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <div className="items-center m-5 pb-10 pt-10">
                    ...
                    <form onSubmit={handleCreateStuff} className="max-w-sm mx-auto">
                        <div className="mb-5">
                            {/* di penamaan:
                            1. syntax putih/placeholder => terserah front end
                            2. SELAIN syntax putih/placeholder => terserah backend */}

                            {/* tag select, bagian optionnya ambil dari backend */}
                        ...
                        <div className="mb-5">
                            ...
                            <select id="category" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required onChange={e => setForms({ ...forms, category: e.target.value })}>
                                ...
                                <option value="Teknisi/Sarpras">Teknisi atau Sarpras</option>
                            </select>
                        </div>
