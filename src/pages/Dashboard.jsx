...
export default function Dashboard() {
    ...
    const getDataInbounds = () => {
        axios.get('http://localhost:8000/InboundStuff', {
            headers: {
                "Authorization": 'Bearer ' + localStorage.getItem('access_token'),
            }
        })
    ...
    return (
        <Case>
            ...
            <div className="flex flex-wrap justify-center mx-4">
                ...
                <InfoCard title="Data Inbound" count={inbounds.length} icon="handshake" />

                <div className="p-4 w-full">
                    <div className="flex justify-between items-center mb-4">
                        <div>
                            <label className="mr-2 text-white" >Mulai</label>
                            <DatePicker
                                selected={startDate}
                            ...
                            />
                            <label className="ml-4 mr-2 text-white" >Sampai</label>
                            <DatePicker
                                selected={endDate}
