                        ...
                        <table className="min-w-full text-left text-sm font-light">
                            ...
                            <tbody>
                                {inbounds.map((inbound, id) => (
                                    <tr key={inbound.id} className="border-b dark:border-neutral-500 dark:text-white">
                                        ...
                                        <td className="whitespace-nowrap px-6 py-4"><img src={"http://localhost:8000/uploads/" + inbound.proff_file} width={100} height={90} /></td>
