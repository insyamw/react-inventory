    ...
    return (
        <Case>
            <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                {
                    alert ? (
                        <div className="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 dark-bg:bg-gray-800 dark:text-green-400" role="alert">
                            <span className="font-medium">Success!</span> Check inbound data in <b><Link>this page</Link></b>
                        </div>
                    ) : ''
                }
                {
                ...
                <form onSubmit={handleSubmitForm} className="max-w-sm mx-auto">
